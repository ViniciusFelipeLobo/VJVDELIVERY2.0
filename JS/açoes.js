...
const menu = document.querySelector('#menu'), sobre = document.querySelector('#sobre'), lista = document.querySelector('ul'), larguraDaTela = window.innerWidth, section = document.querySelector('section'), botoes = document.getElementsByTagName('button'), seletorLanches = document.getElementById('seletorlanches'), seletorHotdogs = document.getElementById('seletorhotdogs'), seletorPasteis = document.getElementById('seletorpasteis'), seletorAçais = document.getElementById('seletoraçais'), seletorVitaminas = document.getElementById('seletorvitaminas'), seletorBebidas = document.getElementById('seletorbebidasemgeral'), seletorRefrigerantesGrandes = document.getElementById('seletorregfrigerantesgrandes'), tableLanches = document.getElementById('tablelanches'),tableHotDogs = document.getElementById('tablehotdogs'), tablePasteis = document.getElementById('tablepasteis'), tableAçais = document.getElementById('tableaçais'), tableVitaminas = document.getElementById('tablevitaminas'), tableBebidas = document.getElementById('tablebebidasemgral'), tableRefrigerantesGrandes = document.getElementById('tablerefrigerantesgrandes'), table = document.querySelectorAll('table');
